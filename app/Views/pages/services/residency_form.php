...
<section class="service-form-page py-5">
    <div class="container">
        <h2 class="section-title text-center mb-4">BRGY Certificate of Residency Form</h2>
        <p class="text-center text-muted mb-5">
            Fill out the form below to request your Barangay Certificate of Residency online.
        </p>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <form action="<?= base_url('service/residency-submit') ?>" method="POST" enctype="multipart/form-data">
