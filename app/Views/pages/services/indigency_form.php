...
<section class="service-form-page py-5 sections">
    <div class="container">
        ...
        <p class="text-center text-muted mb-5">
            Fill out the form below to request your Barangay Certificate of Indigency online.
        </p>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <form action="<?= base_url('service/indigency-submit') ?>" method="POST" enctype="multipart/form-data">
